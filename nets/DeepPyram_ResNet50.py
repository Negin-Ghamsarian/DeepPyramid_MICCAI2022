...
if __name__ == '__main__':
    ...
    model_without_PyramidLoss = DeepPyram_ResNet50(n_channels=3, n_classes=1, bilinear=True, Pyramid_Loss=False)
    ...
    model_with_PyramidLoss = DeepPyram_ResNet50(n_channels=3, n_classes=1, bilinear=True, Pyramid_Loss=True)
